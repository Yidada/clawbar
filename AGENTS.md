...
- `python3 Tests/Harness/clawbarctl.py test integration --suite all`: run grouped XCTest suites for Feishu, WeChat, Provider, Gateway, and Installer flows.
