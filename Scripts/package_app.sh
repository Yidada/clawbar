...
ZIP_BASENAME="${ZIP_BASENAME:-${PRODUCT_NAME}-${APP_VERSION}-${BUILD_TIME_TAG}-${APP_BUILD}-${GIT_COMMIT}}"
DMG_BASENAME="${DMG_BASENAME:-${PRODUCT_NAME}-${APP_VERSION}-${BUILD_TIME_TAG}}"
